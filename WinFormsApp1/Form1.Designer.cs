...
namespace WinFormsApp1
{
    partial class Form1
    {
		...
		private void InitializeComponent()
		{
			...
			label2.Location = new Point(463, 32);
			label2.Name = "label2";
			...
			label3.Location = new Point(637, 32);
			label3.Name = "label3";
			...
			label4.Location = new Point(70, 32);
			label4.Name = "label4";
			...
			listView1.Location = new Point(257, 63);
			listView1.Margin = new Padding(20);
			listView1.MultiSelect = false;
			listView1.Name = "listView1";
			listView1.Size = new Size(176, 356);
			...
			listView2.Location = new Point(439, 63);
			listView2.Margin = new Padding(20);
			listView2.MultiSelect = false;
			listView2.Name = "listView2";
			listView2.Size = new Size(165, 356);
			...
			listView3.Location = new Point(610, 63);
			listView3.Margin = new Padding(20);
			listView3.Name = "listView3";
			listView3.Size = new Size(174, 356);
			...
			listView4.Location = new Point(8, 63);
			listView4.Margin = new Padding(20);
			listView4.MultiSelect = false;
			listView4.Name = "listView4";
			listView4.Size = new Size(243, 353);
			...
			button3.Location = new Point(579, 6);
			...
			dateTimePicker2.Location = new Point(439, 6);
			dateTimePicker2.Name = "dateTimePicker2";
			dateTimePicker2.Size = new Size(134, 23);
			dateTimePicker2.TabIndex = 12;
			dateTimePicker2.Value = new DateTime(2025, 11, 3, 16, 49, 42, 899);
			// 
			// dateTimePicker1
			// 
			dateTimePicker1.CustomFormat = "yyyy-MM-dd, HH:mm:ss";
			dateTimePicker1.Format = DateTimePickerFormat.Custom;
			dateTimePicker1.Location = new Point(304, 6);
			dateTimePicker1.Name = "dateTimePicker1";
			dateTimePicker1.Size = new Size(129, 23);
			dateTimePicker1.TabIndex = 9;
			dateTimePicker1.Value = new DateTime(2025, 11, 3, 16, 49, 42, 904);
			// 
			// tabPage1
			// 
			...
			schedulerControl2.Size = new Size(786, 416);
